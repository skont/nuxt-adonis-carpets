    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="c in customers" v-bind:key="c">
          ...
          <td><nuxt-link :to="{ name: 'customers-addCustomer' }"><font-awesome-icon icon="plus"/></nuxt-link> <nuxt-link :to="{name: 'customers-delete-id', params: { id: c.Id }}"><font-awesome-icon icon="minus"/></nuxt-link></td>
        </tr>
      </tbody>
    </table>
  </div>
